...
vcf_bulk = readVcf("~/hpc/pmc_vanboxtel/projects/Burkitt/1_Input/ASAP_FROM_CLOUD/P856/batch_bulk/vcf/germline/somatic_filtering/SMuRF/P856_bulk.vep.SMuRF.filtered.sorted.vcf.gz")
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/CellPhy/Figures/P856_absolute_tree_with_branch_info.pdf",
  plot = p1,
  width = 8,
  height = 6
)
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/CellPhy/Figures/P856_absolute_tree.pdf",
  plot = p2,
  width = 8,
  height = 6
)
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/CellPhy/Figures/P856_absolute_tree_with_bootstraps.pdf",
  plot = p2b,
  width = 8,
  height = 6
)
...
filtered_samples <- unique(c(low_call_frac_df$Sample_name, below_curve_df$Sample_name, bad_baf_df$Sample_name, fail_vaf_df$samplename))  # samples that didn't pass QC
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/CellPhy/Figures/P856_absolute_tree_corrected_for_callable_loci.pdf",
  plot = p3,
  width = 8,
  height = 6
)
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/CellPhy/Figures/P856_absolute_tree_with_bootstraps_corrected_for_callable_loci.pdf",
  plot = p3b,
  width = 8,
  height = 6
)
...
group3 <- c("c", "b", "e", "h", "g")
group4 <- c("p", "r")
group5 <- c("J", "I", "L", "H", "O", "G", "R", "U", "T", "W", "Y", "C", "B", "A", "C2", "A2", "F", "u", "t", "w", "q")
group6 <- c("l", "k")
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/CellPhy/Figures/P856_bulk_VAF_distribution_histogram_PL.pdf",
  plot = p4a,
  width = 8,
  height = 6
)
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/CellPhy/Figures/P856_bulk_VAF_distribution_violin_LN.pdf",
  plot = p5a,
  width = 8,
  height = 6
)
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/CellPhy/Figures/P856_bulk_VAF_distribution_intermediate_branches_violin_PL.pdf",
  plot = p6a,
  width = 8,
  height = 6
)
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/CellPhy/Figures/P856_bulk_VAF_distribution_histogram_BM.pdf",
  plot = p4b,
  width = 8,
  height = 6
)
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/CellPhy/Figures/P856_bulk_VAF_distribution_violin_BM.pdf",
  plot = p5b,
  width = 8,
  height = 6
)
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/CellPhy/Figures/P856_bulk_VAF_distribution_intermediate_branches_violin_BM.pdf",
  plot = p6b,
  width = 8,
  height = 6
)
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/MutationalPatterns/Figures/Trees/P856_reconstructed_cosine_without_PTA.pdf",
  plot = p7,
  width = 8,
  height = 6
)
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/MutationalPatterns/Figures/Trees/P856_reconstructed_cosine_with_PTA.pdf",
  plot = p8,
  width = 8,
  height = 6
)
...
p9 <- plot_tree_contribution_bars_new_alex(
  ...
  branch_color = "#000000",
  x_limits = c(0, 3400),
  x_breaks = seq(0, 3400, by = 200)
)

# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/MutationalPatterns/Figures/Trees/P856_signatures_in_tree_with_PTA.pdf",
  plot = p9,
  width = 8,
  height = 6
)
...
contribution_wide <- contribution_wide |>
  mutate(
    BL = coalesce(`BL-Intermediate-PL`, 0) + coalesce(`BL-Intermediate-BM`, 0) + coalesce(`BL-Private-PL`, 0) + coalesce(`BL-Private-BM`, 0)
  )

# Re-order

contribution_wide <- contribution_wide |>
  dplyr::select(sample, WT, BL, "BL-Trunk", "BL-Intermediate-PL", "BL-Private-PL", "BL-Intermediate-BM", "BL-Private-BM" )
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/MutationalPatterns/Figures/Trees/P856_signatures_per_group_with_PTA.pdf",
  plot = p10,
  width = 8,
  height = 6
)
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/MutationalPatterns/Figures/Trees/P856_signatures_per_group_without_PTA.pdf",
  plot = p11,
  width = 8,
  height = 6
)
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/MutationalPatterns/Figures/Trees/P856_signatures_per_group_without_PTA_sub.pdf",
  plot = p11_sub,
  width = 8,
  height = 6
)
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/MutationalPatterns/Figures/Trees/P856_signatures_per_group_without_PTA_separate_bars.pdf",
  plot = p11b,
  width = 8,
  height = 6
)
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/MutationalPatterns/Figures/Trees/P856_signatures_per_group_without_PTA_separate_bars_sub.pdf",
  plot = p11b_sub,
  width = 8,
  height = 6
)
...
sample_groups <- c(
  ...
  setNames(rep("BL-Intermediate-PL", length(group2)), group2),
  setNames(rep("BL-Private-PL", length(group3)), group3),
...
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/MutationalPatterns/Figures/Trees/P856_CTpG_fraction_custom_groups.pdf",
  plot = p11c,
  width = 6,
  height = 4.5
)
...
agedf <- data.frame(
  ...
  mutate(age = case_when(
    grepl("LLP4", tip.label) ~ 14.75,
    grepl("DUB", tip.label) ~ 14.75,
    TRUE ~ 15.45
  ))
...
p12 <- plot_tree_contribution_bars_new_alex(
  ...
  title = "P856", bar_height = 0.02, scaling = 0.8, add_branch_length = F,
  branch_color = "#000000",
  x_limits = c(0, 3000),
  x_breaks = seq(0, 3400, by = 200)
)
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/MutationalPatterns/Figures/Trees/P856_signatures_in_tree_without_PTA_callable_loci_corrected.pdf",
  plot = p12,
  width = 8,
  height = 6
)
...
tip_data <- input_df_P856 %>%
  mutate(
    ...
    shape_group = ifelse(Biopsy_type == "PL", 16, 17)  # 16 = filled circle, 17 = filled triangle
  )
...
p13 <- plot_gg_tree(
  ...
  scale_shape_manual(values = c("PL" = 16, "BM" = 17)) +
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/CellPhy/Figures/P856_absolute_tree_without_PTA_corrected_for_callable_loci.pdf",
  plot = p13,
  width = 8,
  height = 6
)
...
branch_mm_ctg <- branch_mm_corrected[grep("\\[C>T\\]G", rownames(branch_mm_corrected)), ]
ctg_totals <- colSums(branch_mm_ctg, na.rm = TRUE)
ctg_totals[is.na(ctg_totals)] <- 0
ctg_totals <- as.integer(ctg_totals) |> setNames(names(ctg_totals))
...
agedf <- data.frame(
  ...
  mutate(age = case_when(
    grepl("LLP4", tip.label) ~ 14.75, # 14.0 + 0.75 for conception until birth time
    grepl("DUB", tip.label) ~ 14.75, # 14.0 + 0.75 for conception until birth time
    TRUE ~ 15.45 # 14.7 + 0.75 for conception until birth time
  ))
phylo_tree$agedf<-agedf
ggtree(phylo_tree)
...
res_P856=fit_tree(tree=phylo_tree,switch_nodes = c(49),niter = 1000, cores = 4, model = "poisson_tree", early_growth_model_on = 1.0)
...
# Create the plot
p <- ggtree(res_P856$ultratree, , color = "grey") +
  theme_tree2() +
  scale_x_continuous(name = "Age (Years)", limits = c(0, 16), breaks = 0:16) +
  theme(
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/Rtreefit/Figures/P3G6_ultrametric_tree_ctg_corrected.pdf",
  plot = p,
  width = 8,
  height = 6
)
