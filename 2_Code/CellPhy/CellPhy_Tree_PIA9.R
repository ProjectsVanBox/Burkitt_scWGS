...
# Description: Script to look at CellPhy Tree of Donor PIA9 (branch VCFs for manual checking, choosing percentage, signatures per branch)
...
tree = readRDS("~/hpc/pmc_vanboxtel/projects/Burkitt/3_Output/TreeBuilding_Alex/PIA9/Filtered_samples_v4/CPW_04/TreeObject0.4.RDS")
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/CellPhy/Figures/PIA9_absolute_tree_with_branch_info.pdf",
  plot = p1,
  width = 8,
  height = 6
)
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/CellPhy/Figures/PIA9_absolute_tree.pdf",
  plot = p2,
  width = 8,
  height = 6
)
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/CellPhy/Figures/PIA9_absolute_tree_with_bootstraps.pdf",
  plot = p2b,
  width = 8,
  height = 6
)
...
corrected_tree <- correct_branches(tree, input_df_PIA9_filtered)
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/CellPhy/Figures/PIA9_absolute_tree_corrected_for_callable_loci.pdf",
  plot = p3,
  width = 8,
  height = 6
)
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/CellPhy/Figures/PIA9_absolute_tree_with_bootstraps_corrected_for_callable_loci.pdf",
  plot = p3b,
  width = 8,
  height = 6
)
...
group1 <- c("a2")
group2 <- c("d2", "E3", "C3", "t2", "s2", "e2", "G3", "I3","J3")
group3 <- c("L","K","N","P","I","H","G","T","W","V","Y","B","A","M3","E","D","b","H3","I2","k2","n2","j2","q2","h2","g2","f2","z2","y2","x2","v2","u2","D3","c2","b2")
group4 <- c("s", "r", "u","u", "w", "p", "o", "z", "n", "m", "E2", "D2", "I", "I2", "K2", "M2", "O2", "k", "R2", "j","i", "V2", "X2", "h", "c", "d")
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/CellPhy/Figures/PIA9_bulk_VAF_distribution_histogram.pdf",
  plot = p4,
  width = 8,
  height = 6
)
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/CellPhy/Figures/PIA9_bulk_VAF_distribution_violin.pdf",
  plot = p5,
  width = 8,
  height = 6
)
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/CellPhy/Figures/PIA9_bulk_VAF_distribution_intermediate_branches_violin.pdf",
  plot = p6,
  width = 8,
  height = 6
)
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/MutationalPatterns/Figures/Trees/PIA9_reconstructed_cosine_without_PTA.pdf",
  plot = p7,
  width = 8,
  height = 6
)
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/MutationalPatterns/Figures/Trees/PIA9_reconstructed_cosine_with_PTA.pdf",
  plot = p8,
  width = 8,
  height = 6
)
...
p9 <- plot_tree_contribution_bars_new_alex(
  ...
  branch_color = "#000000",
  x_limits = c(0, 2400),
  x_breaks = seq(0, 2400, by = 200)
)

# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/MutationalPatterns/Figures/Trees/PIA9_signatures_in_tree_with_PTA.pdf",
  plot = p9,
  width = 8,
  height = 6
)
...
contribution_matrix
write.csv(contribution_matrix, "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/MutationalPatterns/Data/sbs_contr_per_group_PIA9.csv", row.names = T)

p10 <- plot_contribution(contribution_matrix[,], palette = sig_cols) # All signatures including PTA

# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/MutationalPatterns/Figures/Trees/PIA9_signatures_per_group_with_PTA.pdf",
  plot = p10,
  width = 8,
  height = 6
)
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/MutationalPatterns/Figures/Trees/PIA9_signatures_per_group_without_PTA.pdf",
  plot = p11,
  width = 8,
  height = 6
)
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/MutationalPatterns/Figures/Trees/PIA9_signatures_per_group_without_PTA_sub.pdf",
  plot = p11_sub,
  width = 8,
  height = 6
)
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/MutationalPatterns/Figures/Trees/PIA9_signatures_pre_vs_post_expansion_without_PTA_sub.pdf",
  plot = p11a_sub,
  width = 8,
  height = 6
)
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/MutationalPatterns/Figures/Trees/PIA9_signatures_per_group_without_PTA_separate_bars.pdf",
  plot = p11b,
  width = 8,
  height = 6
)
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/MutationalPatterns/Figures/Trees/PIA9_signatures_per_group_without_PTA_separate_bars_sub.pdf",
  plot = p11b_sub,
  width = 8,
  height = 6
)
...
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/MutationalPatterns/Figures/Trees/PIA9_CTpG_fraction_custom_groups.pdf",
  plot = p11c,
  width = 6,
  height = 4.5
)
...
agedf <- data.frame(
  ...
  age = rep(17.0,118)  # Replace these with your actual ages
)
...
agedf <- data.frame(
  tip.label = metadata$tip.label,  # Must match tree$tip.label
  age = rep(17,118)  # Replace these with your actual ages
)
phylo_tree$agedf<-agedf
ggtree(phylo_tree, )
...
p12 <- plot_tree_contribution_bars_new_alex(
  ...
  title = "PIA9", bar_height = 0.02, scaling = 0.8, add_branch_length = F,
  branch_color = "#000000",
  x_limits = c(0, 2400),
  x_breaks = seq(0, 2400, by = 200)
)
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/MutationalPatterns/Figures/Trees/PIA9_signatures_in_tree_without_PTA_callable_loci_corrected.pdf",
  plot = p12,
  width = 8,
  height = 6
)
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/CellPhy/Figures/PIA9_absolute_tree_without_PTA_corrected_for_callable_loci.pdf",
  plot = p13,
  width = 8,
  height = 6
)
