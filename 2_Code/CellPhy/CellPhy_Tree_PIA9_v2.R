...
# Description: Script to look at CellPhy Tree, branch signatures and Ultrametric tree for Donor PIA9
...
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/CellPhy/Figures/PIA9/PIA9_absolute_tree_with_branch_info.pdf",
  plot = p1,
  width = 8,
  height = 6
)
...
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/CellPhy/Figures/PIA9/PIA9_absolute_tree.pdf",
  plot = p2,
  width = 8,
  height = 6
)
...
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/CellPhy/Figures/PIA9/PIA9_absolute_tree_with_bootstraps.pdf",
  plot = p2b,
  width = 8,
  height = 6
)
...
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/CellPhy/Figures/PIA9/PIA9_absolute_tree_corrected_for_callable_loci.pdf",
  plot = p3,
  width = 8,
  height = 6
)
...
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/CellPhy/Figures/PIA9/PIA9_absolute_tree_with_bootstraps_corrected_for_callable_loci.pdf",
  plot = p3b,
  width = 8,
  height = 6
)
...
saveRDS(branch_vcf, file = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/CellPhy/Data/branch_vcf_PIA9.rds")
branch_grl = convert_vcf_to_granges(branch_vcf_list = branch_vcf, ref_genome = ref_genome)
saveRDS(branch_grl, file = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/CellPhy/Data/branch_grl_PIA9.rds")
...
group1 <- c("a2") # BL trunk
group2 <- c("d2", "E3", "C3", "t2", "s2", "e2", "G3", "I3","J3") # BL intermediate
group3 <- c("L","K","N","P","I","H","G","T","W","V","Y","B","A","M3","E","D","b","H3","I2","k2","n2","j2","q2","h2","g2","f2","z2","y2","x2","v2","u2","D3","c2","b2") # BL private
group4 <- c("s", "r", "u","u", "w", "p", "o", "z", "n", "m", "E2", "D2", "I", "I2", "K2", "M2", "O2", "k", "R2", "j","i", "V2", "X2", "h", "c", "d") # WT
...
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/CellPhy/Figures/PIA9/PIA9_bulk_VAF_distribution_histogram.pdf",
  plot = p4,
  width = 8,
  height = 6
)
...
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/CellPhy/Figures/PIA9/PIA9_bulk_VAF_distribution_violin.pdf",
  plot = p5,
  width = 8,
  height = 6
)
...
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/CellPhy/Figures/PIA9/PIA9_bulk_VAF_distribution_intermediate_branches_violin.pdf",
  plot = p6,
  width = 8,
  height = 6
)
...
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/MutationalPatterns/Figures/Trees/PIA9/PIA9_reconstructed_cosine_per_branch.pdf",
  plot = p7,
  width = 8,
  height = 6
)

write.csv(contribution, file = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/MutationalPatterns/Data/Trees/PIA9_per_branch_sbs_contribution.csv", row.names = TRUE)
...
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/MutationalPatterns/Figures/Trees/PIA9/PIA9_signatures_in_tree.pdf",
  plot = p9,
  width = 8,
  height = 6
)
...
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/MutationalPatterns/Figures/Trees/PIA9/PIA9_signatures_per_group.pdf",
  plot = p10,
  width = 8,
  height = 6
)
...
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/MutationalPatterns/Figures/Trees/PIA9/PIA9_signatures_per_group_separate_bars.pdf",
  plot = p11,
  width = 8,
  height = 6
)
