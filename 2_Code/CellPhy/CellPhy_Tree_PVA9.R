...
# Description: Script to look at CellPhy Tree of Donor PVA9 (branch VCFs for manual checking, choosing percentage, signatures per branch)
...
tree = readRDS("~/hpc/pmc_vanboxtel/projects/Burkitt/3_Output/TreeBuilding_Alex/PVA9/Filtered_samples_v3/CPW_04/TreeObject0.4.RDS")
...
vcf_bulk = VariantAnnotation::readVcf("~/hpc/pmc_vanboxtel/projects/Burkitt/1_Input/ASAP_FROM_CLOUD/PVA9/vcf_batches/batch_bulk/vcf/germline/somatic_filtering/SMuRF/PVA9_bulk.vep.SMuRF.filtered.sorted.vcf.gz")
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/CellPhy/Figures/PVA9_absolute_tree_with_branch_info.pdf",
  plot = p1,
  width = 8,
  height = 6
)
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/CellPhy/Figures/PVA9_absolute_tree.pdf",
  plot = p2,
  width = 8,
  height = 6
)
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/CellPhy/Figures/PVA9_absolute_tree_with_bootstraps.pdf",
  plot = p2b,
  width = 8,
  height = 6
)
...
corrected_tree <- correct_branches(tree, input_df_PVA9_filtered)
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/CellPhy/Figures/PVA9_absolute_tree_corrected_for_callable_loci.pdf",
  plot = p3,
  width = 8,
  height = 6
)
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/CellPhy/Figures/PVA9_absolute_tree_with_bootstraps_corrected_for_callable_loci.pdf",
  plot = p3b,
  width = 8,
  height = 6
)
...
group1 <- c("J3")
group2 <- c("H3", "G3","q2","N","v2", "E3")
group3 <- c("O2", "N2", "Q2", "S2", "H2", "G2", "J2", "L2", "V2", "F2", "C2", "B2", "A2", "a2", "Z2", "z", "e2", "u", "t", "w", "r", "q", "o", "n","c", "b", "e", "h", "g", "k", "a", "Z", "l2","k2", "n2", "Q", "P", "O","T", "W", "V", "A3","z2", "x2", "w2", "D3", "s2", "r2","u2", "M", "L", "I3")
group4 <-  c("L3", "K3", "N3", "K", "G", "F", "I", "T3", "S3", "B", "A")
...
plot_df <- rbind(
  ...
  #data.frame(VAF = vafs_group4, Group = "WT") # because no mutations were found in bulk
)
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/CellPhy/Figures/PVA9_bulk_VAF_distribution_histogram.pdf",
  plot = p4,
  width = 8,
  height = 6
)
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/CellPhy/Figures/PVA9_bulk_VAF_distribution_violin.pdf",
  plot = p5,
  width = 8,
  height = 6
)
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/CellPhy/Figures/PVA9_bulk_VAF_distribution_intermediate_branches_violin.pdf",
  plot = p6,
  width = 8,
  height = 6
)
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/MutationalPatterns/Figures/Trees/PVA9_reconstructed_cosine_without_PTA.pdf",
  plot = p7,
  width = 8,
  height = 6
)
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/MutationalPatterns/Figures/Trees/PVA9_reconstructed_cosine_with_PTA.pdf",
  plot = p8,
  width = 8,
  height = 6
)
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/MutationalPatterns/Figures/Trees/PVA9_signatures_in_tree_with_PTA.pdf",
  plot = p9,
  width = 8,
  height = 6
)
...
contribution_wide <- contribution_wide |>
  dplyr::select(sample, WT, BL_post_expansion, `BL-Trunk`, `BL-Intermediate`, `BL-Private`)
...
contribution_matrix
write.csv(contribution_matrix, "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/MutationalPatterns/Data/sbs_contr_per_group_PVA9.csv", row.names = T)

p10 <- plot_contribution(contribution_matrix[,], palette = sig_cols) # All signatures including PTA

# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/MutationalPatterns/Figures/Trees/PVA9_signatures_per_group_with_PTA.pdf",
  plot = p10,
  width = 8,
  height = 6
)
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/MutationalPatterns/Figures/Trees/PVA9_signatures_per_group_without_PTA.pdf",
  plot = p11,
  width = 8,
  height = 6
)
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/MutationalPatterns/Figures/Trees/PVA9_signatures_per_group_without_PTA_sub.pdf",
  plot = p11_sub,
  width = 8,
  height = 6
)
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/MutationalPatterns/Figures/Trees/PVA9_signatures_pre_vs_post_expansion_without_PTA_sub.pdf",
  plot = p11a_sub,
  width = 8,
  height = 6
)
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/MutationalPatterns/Figures/Trees/PVA9_signatures_per_group_without_PTA_separate_bars.pdf",
  plot = p11b,
  width = 8,
  height = 6
)
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/MutationalPatterns/Figures/Trees/PVA9_signatures_per_group_without_PTA_separate_bars_sub.pdf",
  plot = p11b_sub,
  width = 8,
  height = 6
)
...
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/MutationalPatterns/Figures/Trees/PVA9_CTpG_fraction_custom_groups.pdf",
  plot = p11c,
  width = 6,
  height = 4.5
)
...
agedf <- data.frame(
  ...
  age = rep(12.7,126)  # Replace these with your actual ages
)
...
p12 <- plot_tree_contribution_bars_new_alex(
  ...
  title = "PVA9", bar_height = 0.02, scaling = 0.8, add_branch_length = F,
  branch_color = "#000000",
  x_limits = c(0, 3600),
  x_breaks = seq(0, 3600, by = 200)
)
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/MutationalPatterns/Figures/Trees/PVA9_signatures_in_tree_without_PTA_callable_loci_corrected.pdf",
  plot = p12,
  width = 8,
  height = 6
)
...
# Save as PDF
ggsave(
  filename = "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/CellPhy/Figures/PVA9_absolute_tree_without_PTA_corrected_for_callable_loci.pdf",
  plot = p13,
  width = 8,
  height = 6
)
