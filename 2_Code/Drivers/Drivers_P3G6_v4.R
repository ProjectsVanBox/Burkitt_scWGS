...
# Plot
pdf("~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/Drivers/Figures/P3G6_oncoprint_burkitt_genes.pdf",
    width = 10, height = 6)
...
# Plot
pdf("~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/Drivers/Figures/P3G6_oncoprint_pan_cancer_genes.pdf",
    width = 10, height = 6)
