...
sample_group <- ifelse(ordered_samples %in% P856_samples_filtered, "Ascites", NA)
...
# Plot
pdf("~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/Drivers/Figures/P856_oncoprint_20250926.pdf",
    width = 10, height = 6)
