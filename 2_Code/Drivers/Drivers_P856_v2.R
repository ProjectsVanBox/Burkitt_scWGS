...
# folder containing the P856 batch VCFs

vcf_dir <- "~/hpc/pmc_vanboxtel/projects/Burkitt/2_Code/Drivers/Markus/P856/Single_cell_drivers"
...
if (length(vcf_files) == 0) stop("No P856 batch VCFs found in: ", vcf_dir)
...
oncoplot_matrix <- oncoplot_matrix %>%
  dplyr::select(driver, all_of(P856_samples))

# export driver list 

drivers_by_sample_P856 <- oncoplot_matrix %>%
  pivot_longer(
    cols = -driver,
    names_to = "sample",
    values_to = "val",
...
write_xlsx(drivers_by_sample_P856, "Data/drivers_by_sample_P856.xlsx")
...
# Plot
pdf("~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/Drivers/Figures/P856_oncoprint_burkitt_genes.pdf",
    width = 10, height = 6)
...
# Plot
pdf("~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/Drivers/Figures/P856_oncoprint_pan_cancer_genes.pdf",
    width = 10, height = 6)
