...
drivers_by_sample_PJBU <- oncoplot_matrix %>%
  pivot_longer(
    cols = -driver,
    names_to = "sample",
    values_to = "val",
...
write_xlsx(drivers_by_sample_PJBU, "Data/drivers_by_sample_PJBU.xlsx")
...
# Plot
pdf("~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/Drivers/Figures/PJBU_oncoprint_burkitt_genes.pdf",
    width = 10, height = 6)
...
# Plot
pdf("~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/Drivers/Figures/PJBU_oncoprint_pan_cancer_genes.pdf",
    width = 10, height = 6)
