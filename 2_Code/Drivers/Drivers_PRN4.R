...
vcf_dir <- "~/hpc/pmc_vanboxtel/projects/Burkitt/2_Code/Drivers/Markus/PRN4/Single_cell_drivers"
...
if (length(vcf_files) == 0) stop("No PRN4 batch VCFs found in: ", vcf_dir)
...
oncoplot_matrix <- oncoplot_matrix %>%
  dplyr::select(driver, all_of(PRN4_samples))
...
sample_group <- ifelse(ordered_samples %in% PRN4_samples_filtered, "Ascites", NA)
...
# Plot
pdf("~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/Drivers/Figures/PRN4_oncoprint_20250926.pdf",
    width = 10, height = 6)
...
samples_in_clade_wo_driver <- c(
  "PRN4GPDLBC19",
  "PRN4GPDLBC16",
  "PB08410-BLLN-BCELLP4G10",
  "PRN4GPDLBC10",
  "PB08410-BLLN-BCELLP2E10",
  "PB08410-BLLN-BCELLP2B10",
  "PRN4GPDLBC20",
  "PB08410-BLLN-BCELLP1B11",
  "PRN4GPDLBC22",
  "PB08410-BLLN-BCELLP4B1",
  "PB08410-BLLN-BCELLP2D10",
  "PB08410-BLLN-BCELLP4D10",
  "PRN4GPDLBC23",
  "PRN4GPDLBC21",
  "PB08410-BLLN-BCELLP4F10",
  "PRN4GPDLBC11",
  "PRN4GPDLBC09"
)
...
# Keep drivers: >=2 in clade AND 0 elsewhere
...
sample_group_sub <- ifelse(ordered_subset %in% PRN4_samples_filtered, "Ascites", NA)
...
oncoPrint(
  ...
  alter_fun              = alter_fun,
  col                    = col,
  column_title           = "PRN4 oncoplot (clade-only drivers ≥2)",
  heatmap_legend_param   = heatmap_legend_param,
  show_column_names      = TRUE,
