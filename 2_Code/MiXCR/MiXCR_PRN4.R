...
write.table(combined_df, "~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/MIXCR/Data/PRN4_combined_df.txt")

# Possibility to continue from saved df

combined_df <- read.table("~/surfdrive/Shared/pmc_vanboxtel/projects/Burkitt_github/3_Output/MIXCR/Data/PRN4_combined_df.txt")
...
pdf("Figures/PRN4_MiXCR_BCR_complete_heatmap.pdf", width=8, height=14)
Heatmap(t(bcr_mat),
        na_col="white",
        col=col_discrete,
        color_space = "RBG",
