...
for (sample_id in unique_samples) {
  ...
  ggsave(filename = paste0("Figures/VAF_distribution_", novogene_label, "_", date, ".pdf"),
  ...
  ggsave(filename = paste0("Figures/VAF_distribution_with_residual_info_", novogene_label, "_", date, ".pdf"),
  ...
  ggsave(filename = paste0("Figures/VAF_distribution_with_BAF_info_", novogene_label, "_", date, ".pdf"),
