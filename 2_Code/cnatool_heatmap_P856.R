...
P856_samples <-  c("PB14458-BLPL-BCELLP4D5", "P856GDDUBC42", "PB14458-BLPL-BCELLP4B5","P856GDDUBC41", "P856GDDUBC44", "P856GDDUBC40", "P856GDDUBC43", "P856GDDUBC45", "P856GDDUBC32","PB14458-BLPL-BCELLP4C3", "PB14458-BLPL-BCELLP4L3", "PB14458-BLPL-BCELLP4K5",  "PB14458-BLPL-BCELLP4J3", "PB14458-BLPL-BCELLP4K3", "P856GDDUBC34", "PB14458-BLPL-BCELLP4M3", "PB14458-BLPL-BCELLP4B3", "PB14458-BLPL-BCELLP4L5", "PB14458-BLPL-BCELLP4E3", "P856GDDUBC33", "PB14458-BLPL-BCELLP4D3", "P856GDDBBC63", "PB14458-BLBM-BCELLP2F2", "PB14458-BLBM-BCELLP2B3", "P856GDDBBC60", "P856GDDBBC46", "PB14458-BLBM-BCELLP2B4", "PB14458-BLBM-BCELLP2C4", "PB14458-BLBM-BCELLP2N2", "P856GDDBBC59", "P856GDDBBC64", "PB14458-BLBM-BCELLP2F4", "PB14458-BLBM-BCELLP2N4", "P856GDDBBC58", "P856GDDBBC54", "P856GDDBBC48", "PB14458-BLBM-BCELLP2I2", "PB14458-BLBM-BCELLP2E4",  "PB14458-BLBM-BCELLP2L4", "PB14458-BLBM-BCELLP2L3", "P856GDDBBC61", "P856GDDBBC57", "P856GDDBBC62" ,"PB14458-BLBM-BCELLP2M4") 

p2 <- ggplot(heatmap_df2_sub) +
  geom_tile(aes(Pos,Sample, width = w, fill=RatioCorrected)) +
  scale_fill_gradientn(limits = c(0,4), values=c(1, .6, .6, .5, .4, 0), colours=c("darkred", "red", "white", "white","white", "blue")) +
  facet_nested( . ~ factor(Chromosome, levels = c(1:22,"X","Y")) + arm, scales = "free_x", space = "free_x") +
  scale_y_discrete(limits = P856_samples) +
  theme_classic() +
  theme( panel.spacing = unit(0,'lines')) 
