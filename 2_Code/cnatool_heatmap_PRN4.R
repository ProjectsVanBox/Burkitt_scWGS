...
PRN4_samples <- c("PRN4GPDLBC05", "PB08410-BLBM-BCELLP2E8", "PRN4GPDBBC07", "PB08410-BM-BCELL2C9", "PB08410-BLBM-BCELLP2C8","PB08410-BLBM-BCELLP5G10", "PB08410-BM-BCELL2C8","PB08410-BLBM-BCELLP2B8", "PB08410-BM-BCELL2E6", "PB08410-BLBM-BCELLP2G8", "PB08410-BLBM-BCELLP2D8", "PB08410-BLBM-BCELLP5E8", "PB08410-BLBM-BCELLP5F8", "PRN4GPDLBC17", "PRN4GPDLBC15", "PRN4GPDLBC12","PRN4GPDLBC11","PRN4GPDLBC09", "PB08410-BLLN-BCELLP4F10",  "PRN4GPDLBC21", "PRN4GPDLBC23", "PB08410-BLLN-BCELLP4D10", "PB08410-BLLN-BCELLP2D10", "PB08410-BLLN-BCELLP4B11","PRN4GPDLBC22", "PB08410-BLLN-BCELLP1B11", "PRN4GPDLBC20", "PB08410-BLLN-BCELLP2B10","PB08410-BLLN-BCELLP2E10",  "PRN4GPDLBC10", "PB08410-BLLN-BCELLP4G10", "PRN4GPDLBC19", "PRN4GPDLBC16")
...
p2 <- ggplot(heatmap_df2_sub) +
  ...
  scale_fill_gradientn(limits = c(0,4), values=c(1, .6, .6, .5, .4, 0), colours=c("darkred", "red", "white", "white","white", "blue")) +
  facet_nested( . ~ factor(Chromosome, levels = c(1:22,"X","Y")) + arm, scales = "free_x", space = "free_x") +
  scale_y_discrete(limits = PRN4_samples) +
  theme_classic() +
  theme( panel.spacing = unit(0,'lines')) 
