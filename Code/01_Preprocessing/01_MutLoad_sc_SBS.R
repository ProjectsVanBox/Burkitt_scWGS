...
# Description: Script to get filtered SBS (total + autosomal) from single cell WGS samples 
...
single_cell_file_names <- readLines("Data/single_cell_ptato_filtered_file_names_SNVs.txt")
...
#saveRDS(SBSs_raw, file = "total_variants_ResolveDNA_VAF015.RDS") # make sure to change minimal VAF

# Read RDS files 

#SBSs_raw <- readRDS(file = "total_variants_ResolveDNA_VAF015.RDS")
...
## save R objects 
#saveRDS(SBSs_PASS_015_autosomal, file = "autosomal_PASS_variants_VAF015.RDS")
#saveRDS(SBSs_FAIL_VAF_015_autosomal, file = "autosomal_FAILVAF_variants_VAF015.RDS")
...
#ggsave(paste0("Mut_load_filtering_stacked_barplot_VAF015.pdf"))