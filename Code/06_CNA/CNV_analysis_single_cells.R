...
# Description: Build cohort-level CNV consensus (gains/losses/LOH) and plot per-cohort heatmaps
...
# External inputs
cytoband_file <- "Data/cytoBandhg38.txt"
sample_overview_xlsx <- "Data/Sample_overview.xlsx"
bulk_overview_csv    <- "Data/Bulk_sample_overview.csv"
low_callable_csv     <- "low_callable_loci.csv" # generated after running 03_QC_step1.R
below_curve_csv      <- "below_curve_samples.csv" # generated after running 03_QC_step1.R
bad_baf_csv          <- "bad_baf_samples.csv" # generated after running 03_QC_step1.R
fail_vaf_txt         <- "PTA_samples_failVAFcheck.txt" # generated after running 04_QC_step2.R
...
# Load CNVs which are the .integrated.cnvs.txt files produced after running PTATO
...
# summary
summary_prefiltering <- table(cohort_dt$CopyNumber)

cohort_dt$size <- cohort_dt$end - cohort_dt$start
