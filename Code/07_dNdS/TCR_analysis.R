...
branch_grl_P3G6 <- readRDS("branch_grl_P3G6.rds") # generated when running CellPhy_Tree_P3G6.R script
branch_grl_PVA9 <- readRDS("branch_grl_PVA9.rds") # generated when running CellPhy_Tree_PVA9.R script
branch_grl_PIA9 <- readRDS("branch_grl_PIA9.rds") # generated when running CellPhy_Tree_PIA9.R script
branch_grl_PJBU <- readRDS("branch_grl_PJBU.rds") # generated when running CellPhy_Tree_PJBU.R script
branch_grl_P856 <- readRDS("branch_grl_P856.rds") # generated when running CellPhy_Tree_P856.R script
branch_grl_PRN4 <- readRDS("branch_grl_PRN4.rds") # generated when running CellPhy_Tree_PRN4.R script
