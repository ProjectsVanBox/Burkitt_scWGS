...
tree = readRDS("TreeObject0.1.RDS") # Obtain from Mendeley doi: 10.17632/phk5jhhm7d.1 --> CellPhy --> P856
...
# VCF per branch
P856_contribution <- read.csv("P856_per_branch_sbs_contribution.csv", row.names = 1) # generated after running CellPhy_Tree_P856.R script
...
# save(res_P856, file = "res_P856.RData")
# load("res_P856.RData")
...
# Save as PDF
ggsave(
  filename = "P856_ultrametric_tree_sbs1_blood_node50_48_0999.pdf",
  plot = p_P856,
  width = 8,
  height = 6
)
...
# # Save as PDF
ggsave(
filename = "P856_ultrametric_tree_sbs1_blood_node_48_0999.pdf",
   plot = p_P856_v2,
   width = 8,
   height = 6
 )
