...
tree = readRDS("TreeObject0.1.RDS") # Obtain from Mendeley doi: 10.17632/phk5jhhm7d.1 --> CellPhy --> PIA9
...
# VCF per branch
PIA9_contribution <- read.csv("PIA9_per_branch_sbs_contribution.csv", row.names = 1) # generated after running CellPhy_Tree_PIA9.R script
...
# Save as PDF
ggsave(
  filename = "PIA9_ultrametric_tree_sbs1_blood_wo_PIA9GTDBBC56.pdf",
  plot = p56,
  width = 8,
  height = 6
)
