...
tree = readRDS("TreeObject0.1.RDS") # Obtain from Mendeley doi: 10.17632/phk5jhhm7d.1 --> CellPhy --> PRN4
...
# VCF per branch
PRN4_contribution <- read.csv("PRN4_per_branch_sbs_contribution.csv", row.names = 1) # generated after running CellPhy_Tree_PRN4.R script
...
#save(res_PRN4, file = "res_PRN4.RData")
#load("res_PRN4.RData")
...
# Save as PDF
ggsave(
  filename = "PRN4_ultrametric_tree_sbs1_blood_node43_48_0999.pdf",
  plot = p_PRN4,
  width = 8,
  height = 6
)
...
# Save PDF
ggsave(
  filename = "PRN4_ultrametric_tree_sbs1_blood_node45_48_43_0999.pdf",
  plot = p,
  width = 8,
  height = 6
)
